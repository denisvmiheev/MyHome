...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
	...
	Раздел.Имя = НСтр("ru = 'Финансы'");
	Раздел.Идентификатор = Новый УникальныйИдентификатор("199db5e2-c45a-4004-9e87-742579e7a749");
	Раздел.Представление = НСтр("ru = 'Финансы'");
	Раздел.ТипыОбъектов.Добавить(Тип("ДокументСсылка.мх_ВводОстатков"));
	Раздел.ТипыОбъектов.Добавить(Тип("ДокументСсылка.мх_ПеремещениеДенежныхСредств"));
	Раздел.ТипыОбъектов.Добавить(Тип("ДокументСсылка.мх_ВозвратРасходов"));
	Раздел.ТипыОбъектов.Добавить(Тип("ДокументСсылка.мх_РегистрацияДоходов"));
	Раздел.ТипыОбъектов.Добавить(Тип("ДокументСсылка.мх_РегистрацияРасходов"));
	Раздел.ТипыОбъектов.Добавить(Тип("ДокументСсылка.мх_ПланированиеБюджета"));	
...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.мх_ВводОстатков.ПолноеИмя(), "Дата",
		НСтр("ru = 'Финансы'"));

	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.мх_ПеремещениеДенежныхСредств.ПолноеИмя(), "Дата",
		НСтр("ru = 'Финансы'"), "Перемещения.ДатаОперации");

	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.мх_ПланированиеБюджета.ПолноеИмя(), "Дата",
		НСтр("ru = 'Финансы'"), "НачалоПериода");

	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.мх_РегистрацияРасходов.ПолноеИмя(), "Дата",
		НСтр("ru = 'Финансы'"), "Расходы.ДатаОперации");

	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.мх_РегистрацияДоходов.ПолноеИмя(), "Дата",
		НСтр("ru = 'Финансы'"), "Доходы.ДатаОперации");

	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.мх_ВозвратРасходов.ПолноеИмя(), "Дата",
		НСтр("ru = 'Финансы'"), "Расходы.ДатаОперации");
