Процедура ЗаполнитьТаблицуСозданияДокументов() Экспорт
	...
	|ИЗ
	|	ДанныеВыписки КАК ДанныеВыписки
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.мх_КошелькиИСчета КАК КошелькиИСчета
	|		ПО ДанныеВыписки.ИдентификаторКарты = КошелькиИСчета.ИдентификаторКошелька
	|		И ДанныеВыписки.ИдентификаторКарты <> """"
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.мх_СоответствиеКатегорийИОписанийСтатьямЗатрат КАК
...
Процедура СохранитьСоответствияКатегорийИСтатейЗатрат(ВыборкаПоВидамДвижений)
	...
	Пока ВыборкаПоВидамДвижений.Следующий() Цикл
		...
		Пока ВыборкаПоСтрокам.Следующий() Цикл
			...
			МенеджерЗаписи = РегистрыСведений.мх_СоответствиеКатегорийИОписанийСтатьямЗатрат.СоздатьМенеджерЗаписи();
...
Функция СоздатьДокументПеремещения(ВыборкаПоВидамДвижений)
	...
	ДокументПеремещения = Документы.мх_ПеремещениеДенежныхСредств.СоздатьДокумент();
