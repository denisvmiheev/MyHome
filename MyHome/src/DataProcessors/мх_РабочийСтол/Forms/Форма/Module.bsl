...
Процедура БалансБюджета_БалансНажатие(Элемент, СтандартнаяОбработка)
	...
	//@skip-warning
	ПользовательскиеНастройки = мх_СКДВызовСервера.УстановитьНастройкиОтчета("ПланированиеБюджета", ПараметрыДанных, Неопределено);
...
Процедура Расходы_СуммаЗаПериодНажатие(Элемент, СтандартнаяОбработка)
	...
	ПараметрыДанных = Новый Структура("ПериодОтчета", Объект.ПериодОтчета);
	//@skip-warning
	ПользовательскиеНастройки = мх_СКДВызовСервера.УстановитьНастройкиОтчета("АнализРасходов", ПараметрыДанных, Неопределено);
