...
Процедура ДобавитьПланируемыеРасходы(ТаблицаБлоков)
	...
	ПроцедураПолученияДанных = "Обработки.РабочийСтол.ПолучитьПланируемыеРасходы";
	ПроцедураОбновленияДанных = "Обработки.РабочийСтол.ОбновитьПланируемыеРасходы";
...
Функция ДанныеПланируемыхРасходов(Параметры)
	...
	|ИЗ
	|	РегистрНакопления.ПланированиеБюджета.Обороты(&ДатаНачала, &ДатаОкончания, День,) КАК ПланированиеБюджетаОбороты
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрНакопления.Расходы.Обороты(&ДатаНачала, &ДатаОкончания, День,) КАК РасходыОбороты
