...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРасписание = мх_АвтоплатежиСервер.ПолучитьРасписаниеАвтоплатежа(Объект.ИдентификаторРегламентногоЗадания);
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	мх_АвтоплатежиСервер.УстановитьРасписаниеАвтоплатежа(ТекущийОбъект, РасписаниеПлатежа, Объект.Используется);
