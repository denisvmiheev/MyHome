...
Процедура ЗаписатьДанныеСеанса()
	...
	ДанныеСеанса.Вставить("ИнтерфейсОпределен", Истина);
	
	мх_СтандартныеПодсистемыВызовСервера.ЗаписатьДанныеСеанса(ДанныеСеанса);	
...
Процедура ПриУстановкеПараметровФункциональныхОпцийИнтерфейса()
	...
	СтруктураПараметров = Новый Структура("мх_ВариантИнтерфейса", ПолучитьЗначениеПараметраПриложения("НомерСеанса"));
