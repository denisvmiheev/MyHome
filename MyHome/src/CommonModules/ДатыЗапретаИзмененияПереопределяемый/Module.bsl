...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
	...
	Раздел.ТипыОбъектов.Добавить(Тип("ДокументСсылка.ВводОстатков"));
	Раздел.ТипыОбъектов.Добавить(Тип("ДокументСсылка.ПеремещениеДенежныхСредств"));
	Раздел.ТипыОбъектов.Добавить(Тип("ДокументСсылка.ВозвратРасходов"));
	Раздел.ТипыОбъектов.Добавить(Тип("ДокументСсылка.РегистрацияДоходов"));
	Раздел.ТипыОбъектов.Добавить(Тип("ДокументСсылка.РегистрацияРасходов"));
	Раздел.ТипыОбъектов.Добавить(Тип("ДокументСсылка.ПланированиеБюджета"));
...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.ВводОстатков.ПолноеИмя(), "Дата",
		НСтр("ru = 'Финансы'"));

	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.ПеремещениеДенежныхСредств.ПолноеИмя(), "Дата",
		НСтр("ru = 'Финансы'"), "Перемещения.ДатаОперации");

	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.ПланированиеБюджета.ПолноеИмя(), "Дата",
		НСтр("ru = 'Финансы'"), "НачалоПериода");

	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.РегистрацияРасходов.ПолноеИмя(), "Дата",
		НСтр("ru = 'Финансы'"), "Расходы.ДатаОперации");

	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.РегистрацияДоходов.ПолноеИмя(), "Дата",
		НСтр("ru = 'Финансы'"), "Доходы.ДатаОперации");

	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.ВозвратРасходов.ПолноеИмя(), "Дата",
		НСтр("ru = 'Финансы'"), "Расходы.ДатаОперации");
