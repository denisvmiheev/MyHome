...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик					 = Обработчики.Добавить();
	Обработчик.Версия			 = "0.1.1.0";
	Обработчик.Процедура		 = "мх_ОбновлениеИнформационнойБазы.ПерейтиНаВерсию_0_1_1_0";
	Обработчик.РежимВыполнения	 = "Монопольно";
	
	Обработчик					 = Обработчики.Добавить();
	Обработчик.Версия			 = "0.1.2.0";
	Обработчик.Процедура		 = "мх_ОбновлениеИнформационнойБазы.ПерейтиНаВерсию_0_1_2_0";
	Обработчик.РежимВыполнения	 = "Монопольно";
...
Процедура ПерейтиНаВерсию_0_1_1_0() Экспорт
	
	Справочники.мх_Номенклатура.ЗаполнитьТипНоменклатурыПоУмолчанию();
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_0_1_2_0() Экспорт
	
	Справочники.мх_КошелькиИСчета.ЗаполнитьВалютуКошельков();
	РегистрыНакопления.мх_ДвиженияДенежныхСредств.ЗаполнитьВалютуВДвижениях();
	РегистрыНакопления.мх_Доходы.ЗаполнитьВалютуВДвижениях();
	РегистрыНакопления.мх_ДоходыРасходы.ЗаполнитьВалютуВДвижениях();
	РегистрыНакопления.мх_Расходы.ЗаполнитьВалютуВДвижениях();
