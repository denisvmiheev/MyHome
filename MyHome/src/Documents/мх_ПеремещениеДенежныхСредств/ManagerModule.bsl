...
Процедура ИнициализироватьТаблицыДляДвижений(ДокументОбъект) Экспорт
	...
	|	ТаблицаПеремещений.КошелекОткуда.Валюта КАК Валюта,
	...
	|	ТаблицаПеремещений.ДатаОперации КАК Период,
	|	ТаблицаПеремещений.НомерСтроки,
	|	ТаблицаПеремещений.КошелекКуда КАК Кошелек,
	|	ТаблицаПеремещений.КошелекКуда.Валюта КАК Валюта,
	|	ТаблицаПеремещений.СуммаКуда,
